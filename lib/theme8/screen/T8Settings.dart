                ...
                children: <Widget>[
                  ...
                  Container(
                    decoration: boxDecoration(
                        bgColor: t8_white, radius: 8, showShadow: true),
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        T8SettingOptionPattern1(Icons.vpn_key, t8_lbl_password,
                            t8_sub_info_password),
                      ],
                    ),
                  ),
                  Container(
          ...
          children: <Widget>[
            ...
            Column(
              ...
              children: <Widget>[
                text(heading),
                text(info,
                    textColor: t8_textColorSecondary, fontSize: textSizeSMedium)
              ],
            ),
          ],
        ),
