...
BoxDecoration boxDecoration(
  ...
  return BoxDecoration(
    ...
    boxShadow: showShadow
        ? [
            BoxShadow(
                color: social_ShadowColor, blurRadius: 10, spreadRadius: 2)
          ]
      ...
      children: <Widget>[
        GestureDetector(
          ...
          child: Container(
            ...
            height: width * 0.1,
            decoration:
                boxDecoration(showShadow: false, bgColor: social_colorPrimary),
        ...
        GestureDetector(
          ...
          child: Container(
              ...
              decoration:
                  boxDecoration(showShadow: false, bgColor: social_view_color),
