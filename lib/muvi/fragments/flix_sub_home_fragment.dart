...
import 'package:izi_flutter_ui_kit/muvi/models/flix_response.dart';
import 'package:izi_flutter_ui_kit/muvi/screens/flix_movie_detail_screen_2.dart';
import 'package:izi_flutter_ui_kit/muvi/screens/flix_series_detail_screen.dart';
import 'package:izi_flutter_ui_kit/muvi/screens/flix_view_all_movies_screen.dart';
...
import 'package:izi_flutter_ui_kit/muvi/utils/flix_data_generator.dart';
import 'package:izi_flutter_ui_kit/muvi/utils/flix_slider_widget.dart';
...
import 'package:izi_flutter_ui_kit/muvi/utils/resources/flix_size.dart';
        ...
        children: <Widget>[
          SingleChildScrollView(
            child: Column(
              ...
              children: <Widget>[
                headingText(context, keyString(context, "trending_week"))
                    .paddingAll(spacing_standard_new),
                slider,
                headingText(context, keyString(context, "continue_watching"))
                    .paddingOnly(
                  ...
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) => ViewAllMovieScreen(
                              title: keyString(context, "popular_movies"))));
                }).paddingAll(spacing_standard_new),
                popularMovieList,
                headingWidViewAll(context, keyString(context, "new_cinema"),
                  ...
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) => ViewAllMovieScreen(
                              title: keyString(context, "new_cinema"))));
                }).paddingAll(spacing_standard_new),
                newCinemaList,
