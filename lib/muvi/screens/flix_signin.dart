...
import 'package:izi_flutter_ui_kit/muvi/screens/flix_home_screen.dart';
import 'package:izi_flutter_ui_kit/muvi/screens/flix_signup.dart';
...
class SignInScreenState extends State<SignInScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: appBarLayout(context, keyString(context, "login"),
          ...
          Container(
            ...
            child: Align(
              ...
              child: Row(
                ...
                children: <Widget>[
                  text(context, keyString(context, "not_have_account"),
                          fontSize: ts_medium, textColor: muvi_textColorPrimary)
                      .paddingAll(spacing_control),
                  text(context, keyString(context, "register"),
                          fontSize: ts_medium,
