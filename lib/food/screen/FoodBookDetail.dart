...
import 'package:izi_flutter_ui_kit/food/utils/FoodColors.dart';
...
import 'package:izi_flutter_ui_kit/food/utils/FoodImages.dart';
          ...
          return GestureDetector(
            ...
            child: Container(
              ...
              decoration: boxDecoration(
                  ...
                  bgColor: mPeople == index
                      ? food_colorPrimary
                      : food_colorPrimary_light),
              padding: EdgeInsets.fromLTRB(16, 0, 16, 0),
              child: text(mPeopleList[index],
                  textColor:
                      mPeople == index ? food_white : food_textColorPrimary,
                  isCentered: true),
            ),
          );
        },
        ...
        return GestureDetector(
          ...
          child: Container(
            ...
            child: text(mTimeList[index],
                textColor: mTime == index ? food_white : food_textColorPrimary,
                isCentered: true),
          ),
        );
      },
          ...
          return GestureDetector(
            ...
            child: Container(
              ...
              child: text(mFoodList[index],
                  textColor:
                      mFood == index ? food_white : food_textColorPrimary,
                  isCentered: true),
            ),
          );
        },
