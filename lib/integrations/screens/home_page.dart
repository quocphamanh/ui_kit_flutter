...
import 'package:izi_flutter_ui_kit/integrations/utils/data_provider.dart';
import 'package:izi_flutter_ui_kit/main.dart';
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: model.tag.isNotEmpty
                        ? boxDecoration(bgColor: appDarkRed, radius: 4)
                        : BoxDecoration(),
