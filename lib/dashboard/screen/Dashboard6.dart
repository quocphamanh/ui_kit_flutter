...
import 'package:izi_flutter_ui_kit/dashboard/model/db6/Db6Model.dart';
import 'package:izi_flutter_ui_kit/dashboard/utils/Db6BottomNavigationBar.dart';
import 'package:izi_flutter_ui_kit/dashboard/utils/Db6Widget.dart';
import 'package:izi_flutter_ui_kit/dashboard/utils/DbColors.dart';
import 'package:izi_flutter_ui_kit/dashboard/utils/DbConstant.dart';
import 'package:izi_flutter_ui_kit/dashboard/utils/DbDataGenerator.dart';
import 'package:izi_flutter_ui_kit/dashboard/utils/DbExtension.dart';
import 'package:izi_flutter_ui_kit/dashboard/utils/DbImages.dart';
import 'package:izi_flutter_ui_kit/dashboard/utils/DbStrings.dart';
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: Container(
                          decoration:
                              boxDecoration(radius: 16, showShadow: false),
                          child: TextField(
            ...
            child: Column(
              ...
              children: <Widget>[
                Padding(
                  ...
                  child: text(db6_lbl_top_services,
...
class D6Popular extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
        ...
        margin: EdgeInsets.only(left: 16),
        decoration: boxDecoration(
            radius: 10, showShadow: true, bgColor: db6_white, color: db6_white),
        child: ListView(
          shrinkWrap: true,
              ...
              children: <Widget>[
                ...
                GestureDetector(
                  child: Container(
                      ...
                      child: text(db6_lbl_view_offers,
                          textColor: db6_white,
                          fontFamily: fontMedium,
                          textAllCaps: true),
                      decoration:
                          boxDecoration(bgColor: db6_colorPrimary, radius: 6)),
                )
              ],
            )
          ],
