...
import 'package:izi_flutter_ui_kit/dashboard/model/db2/Db2Model.dart';
import 'package:izi_flutter_ui_kit/dashboard/utils/Db2Widget.dart';
                  ...
                  child: Padding(
                    ...
                    child: Container(
                      decoration: boxDecoration(
                          showShadow: true, bgColor: db2_white, radius: 26),
                      child: Stack(
                        ...
                        children: <Widget>[
                          TextField(
                            ...
                            focusedBorder: OutlineInputBorder(
                              borderSide:
                                  BorderSide(color: db2_white, width: 0.5),
          ...
          Padding(
            ...
            child: Row(
              ...
              children: <Widget>[
                text(model.name),
                text("\$100",
                    textColor: db2_textColorSecondary, fontFamily: fontMedium),
              ],
            ),
          )
        ],
