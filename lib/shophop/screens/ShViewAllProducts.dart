...
import 'package:izi_flutter_ui_kit/shophop/models/ShAttribute.dart';
          ...
          return Padding(
            ...
            child: ChoiceChip(
              label: text(categoryList[index].name,
                  textColor:
                      categoryList[index].isSelected ? Colors.red : blackColor),
            ...
            child: InkWell(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    color: colorFromHex(colorsList[index].name)),
