...
import 'package:izi_flutter_ui_kit/main/utils/percent_indicator/linear_percent_indicator.dart';
import 'package:izi_flutter_ui_kit/main/utils/rating_bar.dart';
import 'package:izi_flutter_ui_kit/shophop/models/ShProduct.dart';
import 'package:izi_flutter_ui_kit/shophop/models/ShReview.dart';
        ...
        return GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
                ...
                color: colorFromHex(colorList[index])),
            ...
            Row(
              children: <Widget>[
                ...
                Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    text(sh_lbl_delivered_by, fontSize: textSizeSMedium),
                    text("25 June, Monday",
                        textColor: sh_textColorPrimary,
                        fontSize: textSizeMedium,
                        fontFamily: fontMedium)
                ...
                children: <Widget>[
                  Container(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        reviewText("3.0",
                            size: 28.0, fontSize: 30, fontFamily: fontBold),
