...
import 'package:izi_flutter_ui_kit/theme12/models/T12Models.dart';
import 'package:izi_flutter_ui_kit/theme12/utils/t12_colors.dart';
import 'package:izi_flutter_ui_kit/theme12/utils/t12_constant.dart';
import 'package:izi_flutter_ui_kit/theme12/utils/t12_data_generator.dart';
import 'package:izi_flutter_ui_kit/theme12/utils/t12_widget.dart';
          ...
          return Column(
            ...
            children: <Widget>[
              text(list[index].transactionDate,
                  ...
                  .paddingOnly(top: 12, bottom: spacing_standard)
            ...
            children: <Widget>[
              Container(
                ...
                decoration: boxDecoration(
                    showShadow: true,
                    bgColor:
                        selectedTab == 0 ? t12_primary_color : Colors.white,
              ...
              Expanded(
                child: Container(
                  ...
                  decoration: boxDecoration(
                      showShadow: true,
                      bgColor:
                          selectedTab == 1 ? t12_primary_color : Colors.white,
                      radius: spacing_large),
                  child: text("Received",
              ...
              Expanded(
                child: Container(
                  ...
                  decoration: boxDecoration(
                      showShadow: true,
                      bgColor:
                          selectedTab == 2 ? t12_primary_color : Colors.white,
                      radius: spacing_large),
                  child: text("Spend",
                          textColor: selectedTab == 2
                              ? Colors.white
                              : t12_text_secondary,
                          fontFamily: fontMedium,
                          fontSize: textSizeMedium)
