...
import 'package:izi_flutter_ui_kit/theme1/utils/T1Extension.dart';
...
import 'package:izi_flutter_ui_kit/theme11/utils/T11Images.dart';
import 'package:izi_flutter_ui_kit/theme11/utils/T11Strings.dart';
import 'package:izi_flutter_ui_kit/theme11/utils/T11Widget.dart';
  ...
  Widget build(BuildContext context) {
              ...
              children: <Widget>[
                TextFormField(
                  decoration: InputDecoration(
                    ...
                    labelStyle:
                        primaryTextStyle(size: 20, color: t11_PrimaryColor),
    ...
    final buttonView = Column(
      children: <Widget>[
        ...
        Text(t11_lbl_forgot_password,
                style: boldTextStyle(size: 18, color: t11_PrimaryColor))
            .onTap(() {})
            .paddingAll(16.0),
        MaterialButton(
          child: Text(t11_lbl_create_account)
              .withStyle(fontSize: 18, color: t11_PrimaryColor),
          color: Colors.grey,
