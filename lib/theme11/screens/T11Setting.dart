...
import 'package:izi_flutter_ui_kit/theme11/utils/T11Colors.dart';
import 'package:izi_flutter_ui_kit/theme11/utils/T11Constant.dart';
import 'package:izi_flutter_ui_kit/theme11/utils/T11Strings.dart';
  ...
  Widget build(BuildContext context) {
    final listView = Column(
      ...
      children: <Widget>[
        ...
        Row(
          ...
          children: <Widget>[
            text(t11_lbl_AutoPlay,
                    textColor: t11_blackColor,
                    fontSize: textSizeLargeMedium,
                    fontFamily: fontRegular)
                .paddingOnly(top: 4, left: 8, right: 8, bottom: 8),
            Switch(
              value: isAutoPlay,
              onChanged: (value) {
                setState(() {
        ...
        text(t11_lbl_Normalized_Volume,
                textColor: t11_blackColor,
                fontSize: textSizeNormal,
                fontFamily: fontRegular)
            .paddingOnly(top: 16, left: 8, right: 8),
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: <Widget>[
            text(t11_lbl_SetVolume_allTrack,
        ...
        Row(
          ...
          children: <Widget>[
            Expanded(
                child: text(t11_lbl_when_offline,
                        textColor: t11_PrimaryColor,
                        fontSize: textSizeMedium,
                        fontFamily: fontRegular)
                    .paddingOnly(top: 4, left: 8, right: 8, bottom: 8)),
        ...
        Row(
          ...
          children: <Widget>[
            Expanded(
              child: text(t11_lbl_adjust_volume,
                      textColor: t11_PrimaryColor,
                      fontSize: textSizeMedium,
                      fontFamily: fontRegular)
                  .paddingOnly(top: 4, left: 8, right: 8, bottom: 8),
            ...
            DropdownButton<String>(
              items: <String>[t11_lbl_high, t11_lbl_Normal, t11_lbl_low]
                  .map((String value) {
        ...
        text(t11_lbl_Others,
                ...
                fontSize: textSizeNormal,
                fontFamily: fontRegular)
            .paddingOnly(top: 32, left: 8, right: 8, bottom: 16),
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: <Widget>[
            text(t11_lbl_Download_Speed,
                    textColor: t11_PrimaryColor,
                    fontSize: textSizeNormal,
                    fontFamily: fontRegular)
                .paddingOnly(top: 4, left: 8, right: 8, bottom: 8),
    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
        preferredSize:
            Size(double.infinity, MediaQuery.of(context).size.width * 0.22),
        child: Column(
          children: <Widget>[
            SizedBox(height: 20),
            Container(
              child: Row(
                ...
                children: <Widget>[
                  Icon(Icons.navigate_before, size: 40, color: t11_PrimaryColor)
                      .onTap(() {
                    Navigator.pop(context);
                  }),
                  text(t11_lbl_Settings,
                          textColor: t11_blackColor,
                          fontSize: textSizeNormal,
                          fontFamily: fontBold)
                      .paddingAll(24),
