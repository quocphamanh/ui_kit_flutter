            ...
            TextFormField(
              ...
              decoration: new InputDecoration(
                  ...
                  labelStyle: TextStyle(
                      height: -16, fontSize: 20.0, color: t11_PrimaryColor),
    ...
    final socialAccount = Column(
      ...
      children: <Widget>[
        Column(
          ...
          children: <Widget>[
            SizedBox(height: 50),
            Text(t11_lbl_connect_social_account,
                    style: boldTextStyle(size: 24, color: blackColor))
                .paddingAll(16),
            TextFormField(
              style: primaryTextStyle(size: 20, color: textPrimaryColor),
...
//            ).cornerRadiusWithClipRRect(25).paddingAll(16),
    ...
    final stepView = Row(
      ...
      children: <Widget>[
        ...
        MaterialButton(
          child: Text(t11_lbl_step2).withStyle(
              fontSize: 18, color: btn2 ? whiteColor : t11_PrimaryColor),
        ...
        MaterialButton(
          child: Text(t11_lbl_step3).withStyle(
              fontSize: 18, color: btn3 ? whiteColor : t11_PrimaryColor),
