...
import 'package:izi_flutter_ui_kit/integrations/screens/home_page.dart';
import 'package:izi_flutter_ui_kit/main/model/AppMoel.dart';
import 'package:izi_flutter_ui_kit/main/utils/AppColors.dart';
import 'package:izi_flutter_ui_kit/main/utils/AppConstant.dart';
import 'package:izi_flutter_ui_kit/main/utils/AppImages.dart';
import 'package:izi_flutter_ui_kit/main/utils/AppStrings.dart';
          ...
          onTap: () {
            if (id == 0) {
              launchScreen(context, ProkitScreenListing.tag,
                  arguments: snapshot.data.widgets);
            }
            if (id == 1) {
              launchScreen(context, ProkitScreenListing.tag,
                  arguments: snapshot.data.fullapp);
            }
            if (id == 2) {
              launchScreen(context, ProkitScreenListing.tag,
                  arguments: snapshot.data.dashboard);
            }
            if (id == 3) {
          ...
          child: Stack(
            ...
            children: [
              Container(
                ...
                decoration:
                    boxDecoration(radius: 4, bgColor: color, showShadow: true),
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: <Widget>[
                    SvgPicture.asset(img,
                        width: width / 12, height: width / 12, color: appWhite),
                    text('$name',
                        textColor: appWhite,
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  child: FittedBox(
                      child: text(type, fontSize: 8.0, textColor: appWhite)),
